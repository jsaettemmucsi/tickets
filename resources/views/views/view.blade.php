<x-app-layout>
    ...
    <div class="flex">
        ...
        <div class="w-full mx-auto ml-52">
			<div class="p-4 bg-gray-300 dark:bg-gray-900 text-white flex w-full">
				@isset($view->filter)
					<div class="w-full">
						Filters: {{ $view->filter }}
					</div>
			...
			<x-table-head :headers="$view->columns()" />
				<tbody>
					@foreach ($view->tickets() as $ticket)
						<tr class="hover:bg-gray-50 bg-white dark:bg-gray-900 dark:text-gray-400 hover:bg-gray-800">
